          ...
          <div className="items-center lg:flex lg:min-h-[60vh]">
            <div className="w-full pt-3 sm:pt-0 lg:w-1/2">
              <div className="lg:max-w-xl">
                ...
                <h2 className="mt-4 text-md font-normal text-black md:w-[80%] lg:w-[96%]">
                  Don't let IT woes disrupt your workflow. Our friendly and
                  knowledgeable help desk team provides prompt support, getting
                  you back on track quickly and efficiently.
                </h2>
            ...
            <div className="user_select flex items-center justify-center px-0 sm:px-10 xl:px-0 w-full mt-16 lg:mt-10 lg:w-1/2">
              <img
                ...
                src="https://res.cloudinary.com/dezi0bct4/image/upload/v1713220080/Untitled_design_-_4_sleexi.png"
      ...
      <section className="my-16">
        <div className="px-5 sm:px-10 lg:px-0">
          ...
          <p className="mb-5 text-black w-[100%] sm:w-[90%] md:w-[80%] xl:w-[70%] mx-auto font-medium text-sm sm:text-md lg:text-md xl:text-lg text-center">
            These branches of help desk support play a crucial role in providing
            timely assistance, resolving user issues, and ensuring smooth
            operation of IT services within organizations.
          </p>
          ...
          <div className="mt-20 max-w-7xl mx-auto flex justify-center items-center gap-8 flex-wrap">
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Technical support services involve supporting users with
                technical concerns related to hardware, software, or network
                difficulties. Our help desk technicians troubleshoot and resolve
                technical issues to ensure the efficient operation of IT
                systems.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Our customer support department places a strong emphasis on
                addressing customer inquiries in a timely manner, providing
                detailed product information, resolving complaints effectively,
                and offering guidance with product usage. We are dedicated to
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Imagine never having to sweat over IT hiccups again. At Octa
                Tech, our IT support team is your one-stop shop for all things
                tech-related. From setting up new devices to troubleshooting
                software woes, configuring networks, and resolving connectivity
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Forget the wait for an on-site technician! Octa Tech's remote
                support empowers our help desk heroes to assist you instantly.
                This innovative branch allows us to access your devices
                securely, and troubleshoot issues swiftly remotely. The result?
                Enhanced efficiency, minimized downtime, and a faster return to
                business.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Octa Tech's help desk support goes beyond just resolving
                immediate issues. We offer a holistic approach designed to
                empower your users and optimize your IT environment. Octa Tech's
                help desk support goes beyond just resolving immediate issues.
                In short, we don't just fix problems; we prevent them!
              </p>
            </div>
          </div>
        </div>
