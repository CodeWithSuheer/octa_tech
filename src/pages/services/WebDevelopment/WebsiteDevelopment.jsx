...
const WebsiteDevelopment = () => {
    ...
    return (
        <>
            ...
            <section class="max-w-4xl mx-auto px-5 mt-16 mb-16">

                <div class="text-center">
                    <h2 class="font-semibold text-3xl">Features you'll love</h2>
                    <p class="max-w-md mx-auto mt-2 text-gray-500">Lorem ipsum dolor sabore rerum impedit aperiam omnis modi eum deserunt magni?.</p>
                </div>
