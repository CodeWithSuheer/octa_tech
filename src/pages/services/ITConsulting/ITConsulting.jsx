                ...
                <div className="px-5 sm:px-10 lg:px-0">
                    ...
                    <div className="mt-20 max-w-7xl mx-auto flex justify-center items-center gap-8 flex-wrap">
                        ...
                        <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
                            ...
                            <h2 className='mt-3 text-2xl font-semibold'>IT Assessment and Planning</h2>
                            <p className='mt-2 text-sm sm:text-md'>IT assessment and planning involve evaluating the organization's current IT infrastructure, systems, and processes to identify strengths, weaknesses, opportunities, and threats. It includes developing strategic IT roadmaps, aligning IT initiatives with business goals, and outlining plans for technology adoption and transformation.
                            </p>
                        </div>
                        ...
                        <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
                            ...
                            <h2 className='mt-3 text-2xl font-semibold'>Digital Transformation</h2>
                            <p className='mt-2 text-sm sm:text-md'>Digital transformation focuses on leveraging technology to drive innovation, improve operational efficiency, and enhance customer experiences. It includes assessing digital maturity, implementing digital strategies, and integrating emerging technologies such  as cloud computing, artificial intelligence, and IoT to enable digital growth and competitiveness.
                        ...
                        <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
                            ...
                            <h2 className='mt-3 text-2xl font-semibold'>IT Governance and Compliance</h2>
                            <p className='mt-2 text-sm sm:text-md'>IT governance and compliance entail establishing frameworks, policies, and procedures to ensure that IT operations align with regulatory requirements, industry standards, and best practices. It involves implementing governance structures, risk management frameworks, and compliance controls to mitigate risks and uphold data security and privacy standards.
                        ...
                        <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
                            ...
                            <h2 className='mt-3 text-2xl font-semibold'>Cybersecurity and Risk Management</h2>
                            <p className='mt-2 text-sm sm:text-md'>Cybersecurity and risk management address identifying, assessing, and mitigating cybersecurity risks to protect the organization's digital assets and sensitive information. It includes developing cybersecurity strategies, implementing security controls, conducting risk assessments, and enhancing incident response capabilities to safeguard against cyber threats and breaches.
                        ...
                        <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
                            ...
                            <h2 className='mt-3 text-2xl font-semibold'>IT Service Management</h2>
                            <p className='mt-2 text-sm sm:text-md'>IT service management focuses on delivering high-quality IT services to meet the organization's business needs and user requirements. It involves implementing service management frameworks such as ITIL, optimizing service delivery processes, and enhancing service quality through continuous improvement and customer-centric approaches.
