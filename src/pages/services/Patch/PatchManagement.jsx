          ...
          <div className="items-center lg:flex lg:min-h-[60vh]">
            <div className="w-full pt-3 sm:pt-0 lg:w-1/2">
              <div className="lg:max-w-xl">
                ...
                <h2 className="mt-4 text-md font-normal text-black md:w-[80%] lg:w-[96%]">
                  Looking for automated patch management? Stay ahead of security
                  vulnerabilities with automated patch management. Octa Tech
                  takes the burden off your shoulders, keeping your systems
            ...
            <div className="user_select flex items-center justify-center px-0 sm:px-10 xl:px-0 w-full mt-16 lg:mt-10 lg:w-1/2">
              <img
                ...
                src="https://res.cloudinary.com/dezi0bct4/image/upload/v1713220082/Untitled_design_-_11_udx4we.png"
                alt="Services Image"
              />
            </div>
          </div>
      ...
      <section className="my-16">
        <div className="px-5 sm:px-10 lg:px-0">
          <h2 className="baloo mb-3 text-black font-semibold text-4xl sm:text-4xl xl:text-5xl text-center">
            The branches of patch management include
          </h2>
          <p className="mb-5 text-black w-[100%] sm:w-[90%] md:w-[80%] xl:w-[70%] mx-auto font-medium text-sm sm:text-md lg:text-md xl:text-lg text-center">
            Partner with Octa Tech to fortify your defenses against cyber
            threats. Our patch management services ensure your systems remain
            up-to-date and secure, empowering you to focus on your core business
          ...
          <div className="mt-20 max-w-7xl mx-auto flex justify-center items-center gap-8 flex-wrap">
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Our team meticulously monitors software vendors, security
                advisories, and patch repositories to pinpoint vulnerabilities
                and identify the corresponding patches. This proactive approach
                ensures you stay informed about potential threats and have the
                necessary updates readily available.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Not all patches are created equal. Our rigorous patch testing
                process evaluates patches within a controlled environment to
                guarantee they function seamlessly with your existing software,
                applications, & systems. It minimizes the risk of disruptions
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Efficient patch deployment is paramount. We employ systematic
                rollouts to deliver patches to endpoints, servers, and network
                devices across your organization. We prioritize critical patches
                based on severity levels and leverage automation to streamline
                updates for your entire IT infrastructure.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Patch application is just one step. Our patch compliance
                measures verify that all systems and devices have received and
                implemented the necessary updates in a timely manner. This
                ongoing monitoring ensures your security vulnerabilities are
                addressed promptly, minimizing the window of exploitation for
                cyber threats.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <h2 className="mt-3 text-2xl font-semibold">
                Patch Reporting and Monitoring
              </h2>
              <p className="mt-2 text-sm sm:text-md">
                Transparency is key. We generate comprehensive reports detailing
                patch status, compliance levels, and any lingering
                vulnerabilities across your IT environment. This continuous
                monitoring provides valuable insights and helps us track
                progress and refine your patching strategy for maximum
                effectiveness.
              </p>
            </div>
          </div>
