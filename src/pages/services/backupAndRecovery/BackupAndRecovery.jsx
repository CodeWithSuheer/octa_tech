            ...
            <div className="w-full pt-3 sm:pt-0 lg:w-1/2">
              <div className="lg:max-w-xl">
                ...
                <h2 className="mt-4 text-md font-normal text-black md:w-[80%] lg:w-[96%]">
                  Disaster? No Problem! Be prepared for the unexpected. Our
                  comprehensive backup and disaster recovery solutions minimize
                  downtime and ensure swift restoration in case of emergencies.
                </h2>
      ...
      <section className="my-16">
        <div className="px-5 sm:px-10 lg:px-0">
          <h2 className="baloo mb-3 text-black font-semibold text-4xl sm:text-4xl xl:text-5xl text-center">
            The branches of backup and disaster recovery include
          </h2>
          <p className="mb-5 text-black w-[100%] sm:w-[90%] md:w-[80%] xl:w-[70%] mx-auto font-medium text-sm sm:text-md lg:text-md xl:text-lg text-center">
            Data loss can be devastating. Octa Tech offers a comprehensive suite
            of solutions designed to safeguard your critical information and
            ensure business continuity in the face of any disruption:
          </p>
          ...
          <div className="mt-20 max-w-7xl mx-auto flex justify-center items-center gap-8 flex-wrap">
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Our data backup services prioritize the security of your
                essential data. We create regular copies and store them securely
                offsite, protecting you from accidental deletion, hardware
                failure, or cyberattacks. We employ various backup strategies to
                ensure complete data availability and integrity.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Disruptions are inevitable, but recovery doesn't have to be. Our
                disaster recovery planning helps you develop robust strategies
                and procedures to restore your IT systems and data swiftly after
                a disruptive event, be it a natural disaster, cyberattack, or
                system failure.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Secure and efficient backup storage is crucial. Our backup
                storage management services ensure the optimal storage of your
                backed-up data. We help select the most appropriate storage
                technologies, data deduplication, and compression techniques to
                maximize storage space, backup, and recovery processes.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Our business continuity management services help you develop
                plans to ensure the uninterrupted operation of critical business
                functions during and after a disruptive event. We assist in
                crafting business continuity plans, essential business processes
                and resources to validate the effectiveness of your plans.
              </p>
            </div>
            ...
            <div className="my-3 relative min-h-[16rem] text-center px-5 py-7 bg-white shadow-xl border-2 border-gray-100 hover:border-blue-600 w-[100%] md:w-[70%] lg:w-[40%] xl:w-[35%] rounded-xl">
              ...
              <p className="mt-2 text-sm sm:text-md">
                Leverage the power of the cloud. Our cloud backup and recovery
                solutions offer a scalable and cost-effective way to store
                backup data offsite. Cloud-based backups provide flexibility in
                storage options, automate backups for efficiency, and enable
                rapid data recovery.
              </p>
            </div>
          </div>
