    ...
    return (
        <>
            <section className='relative pt-3 lg:pt-20 lg:pb-12 bg-gray-50'>
                ...
                <div className="max-w-6xl px-4 z-50 sm:px-6 lg:px-3 pt-24 pb-2 lg:pt-0 lg:pb-0 mx-auto">
                    <div className="items-center lg:flex lg:min-h-[60vh]">
                        <div className="w-full pt-3 sm:pt-0 lg:w-1/2">
                            <div className="lg:max-w-xl">
                                <h2 className="mt-3 baloo w-[100%]  xl:w-[90%] text-4xl font-semibold capitalize text-black lg:text-5xl xl:text-6xl">Backup & Recovery</h2>
                                <h2 className="mt-1.5 text-sm sm:text-lg font-normal text-black md:w-[80%] lg:w-[95%]">
                        ...
                        <div className="user_select flex items-center justify-center w-full mt-16 lg:mt-10 lg:w-1/2">
                            <img className="w-full h-full rounded-xl object-contain" src="https://cdn.shopify.com/s/files/1/0704/6378/2946/files/Rectangle_1037_12.png?v=1711653492" alt="Catalogue-pana.svg" />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="rounded-lg">
                        ...
                        <div className="other_services mt-6 border border-gray-300 rounded-lg shadow-lg transition hover:shadow-2xl py-6 flex justify-center items-center">
                            <div className="other_links flex flex-col">
                                ...
                                <Link to='/IT-consulting' onClick={handleScroll} className='py-1.5 flex items-center'>
                                    <FaLocationArrow size={12} className='text-blue-600 mr-2.5 mt-1' />
                                    <span className='hover:underline hover:underline-offset-4'>IT Consulting</span>
                                </Link>
                            </div>
                        </div>
                    </div>
